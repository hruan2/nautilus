...
typedef __attribute((__aligned__(LB_ENTRY_ALIGN))) uint64_t lb_uint64_t;
...
#define GPIO_MAX_NAME_LENGTH 16
	uint8_t __attribute((__nonstring__)) name[GPIO_MAX_NAME_LENGTH];
};
